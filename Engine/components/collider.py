...
class Collider(Component):
    ...
    def __init__(self, mesh_name, tags_to_collide_with=()):
        ...
        self.tags_to_collide_with = list(tags_to_collide_with)
        self.mesh_name = mesh_name

    def initialize(self):
        local_vert = self.node.scene.app.graphics_engine.meshes[self.mesh_name].get_local_xyz_vertices(with_separated_channels=True)
